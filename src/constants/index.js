import {
  ...
  const experiences = [
    ...
    },
    {
      ...
      company_name: "Craftsilicon Limited",
      icon: craft,
      iconBg: "#383E56",
      date: "Jan 2022 - Jan 2023",
      points: [
        "Perform security assessments of company systems and networks to identify vulnerabilities and recommend solutions to mitigate them.",
        "Monitor networks for suspicious activity and take appropriate action in response to incidents.",
        "Investigate security incidents and breaches and develop incident response plans to prevent future occurrences.",
        "Perform penetration testing to evaluate the effectiveness of existing security measures.",
      ],
    },
    {
      title: "Cyber Security Consultant",
      company_name: "Silensec",
      icon: silensec,
      iconBg: "#E6DEDD",
